...
namespace RhythmGameStarter
{
    ...
    public class SongManager : MonoBehaviour
    {
        ...
        // Запуск музыки, задание параметров. Вызывается эвент onSongStartPlay
        ...
        // Приостановление трека. В случае, если трек уже приостановлен, ничего не происходит. 
        // Так же фиксируется время, когда была нажата пауза
        ...
        public void ResumeSong()
        {
            ...
            // Аккумулирует общее время на паузе
            accumulatedPauseTime += AudioSettings.dspTime - dspPausedTime;
        }


        // Полностью останавливает музыку. Вызывается эвент onSongFinished
        ...
        void Update()
        {
            ...
            // Останавливает песню в случае, если она кончилась
